...
def _debug_image(valid_row_index, valid_col_index, row_avg, col_avg, row_diff, col_diff, channel, save_path):
    ...
    save_file_path = save_path / (utils.GlobalConfig.get_device_id() + '_DRCD.csv') 
    channel_data = []
    item_data = []
    index_data = []
    avg_data =[]
...
def defect_row_col_dark(image, thresh, input_pattern, neighbor, save_path, csv_output, debug_flag):
    ...
    if csv_output:
        save_file_path = save_path / 'drcd_data.csv'
...
if __name__ == '__main__':
    file_name = r'G:\CameraTest\image\ET\dark\10f10c010b59c27903023c0b4500400100000000_20241117_092340_Test_0 - 副本.raw'
