...
class TVEBlemish:
    def __init__(self, config_path):
        ...
        self.offsets, self.pad_width, self.num_edges, self.kernel_size = TVEBlemish._precompute_kernel(self.median_kern)
    ...
    def _precompute_kernel(kernel):
        ...
        return offsets, pad, num_edges, kernel_height
    
    @staticmethod
    @jit(nopython=True, parallel=True, fastmath=True)
    def _compute_edge_median_fast(image, offsets, pad, num_edges):
    ...
    def _visualization(image, blemish_map, min_area, blemish_count, final_thresh, blemish_area, down_scale_factor, delta_image, save_path, dpi=50):
        ...
        save_file_path = save_path / 'blemish_data.csv'
    ...
    def run(self, image, save_path):
        ...
        image_median = TVEBlemish._compute_edge_median_fast(image_pad, self.offsets, self.pad_width, self.num_edges)
