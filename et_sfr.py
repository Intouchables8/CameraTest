...
if __name__ == '__main__':
    file_name = r'E:\Wrok\ERS\Diamond ET\Module Images (for algo correlation)\Dukono (non-POR)\SFR'
    save_path = r'E:\Wrok\ERS\Diamond ET\Module Images (for algo correlation)\Dukono (non-POR)\SFR\result'
