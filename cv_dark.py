...
class Dark:
    ...
    def func(self, dpd_file_name, dn_file_name=None, save_path=None):
        ...
        # defect pixel dark
        dpd_map = defect_pixel_dark(dpd_image, self.dpd_cfg.input_pattern, self.dpd_cfg.thresh, self.dpd_cfg.csv_output, self.dpd_cfg.debug_flag, save_path)
        
        # DSNU
        dsnu(dn_images.mean(axis=2), self.dsnu_cfg.roi_size, self.dsnu_cfg.except_dpd, dpd_map, self.dpd_cfg.thresh, self.dsnu_cfg.csv_output, save_path)
...
if __name__ == '__main__':
    dpd_file_name = r'E:\Wrok\ERS\Diamond CV\Module Images'
    dn_file_name = None
